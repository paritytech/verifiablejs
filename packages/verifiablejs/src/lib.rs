...
use verifiable::ring_vrf_impl::ark_vrf::ring::SrsLookup;
use verifiable::{
	ring_vrf_impl::{ring_verifier_builder_params, BandersnatchVrfVerifiable, StaticChunk},
...
pub fn one_shot(
	...
	let members = Vec::<<BandersnatchVrfVerifiable as GenerateVerifiable>::Member>::decode(
		&mut &raw_members[..],
	)
